...
var ProjectViewer = createClass({
	...
	setScreenIndex: function setScreenIndex(nextScreenIndex) {
		var screens = this.props.screens;
		var currentScreenSize = this.state.currentScreenSize;

		var nextScreen = screens[nextScreenIndex];
		var nextImage = nextScreen.images[currentScreenSize];
		var nextScreenSize = currentScreenSize;
	...
	setScreenSize: function setScreenSize(currentScreenSize) {
		this.setState({ currentScreenSize: currentScreenSize });
	},
	render: function render$$1() {
		var _props = this.props,
		...
		var _state = this.state,
		    ...
		    currentScreenSize = _state.currentScreenSize;
